...
@Component({
  selector: 'horario-dia-dialog-form',
  template: `
        ...
        <div class="modal-body">
          <div class="smart-form">
            ...
            <div class="col-md-12">
              ...
              <div id="dialog-message-horario-dia" [saJquiDialog]="{
								autoOpen: false,
								modal: true,
								resizable: false
							  }">
...
export class HorarioDiaDialogFormComponent {
  ...
  dataItemHorarioDia:HorarioDia;

  @Input() public set model(dto: HorarioDia) {
  ...
  cerrarDialogPermiso(){
    this.mensaje = '';
    $( '#dialog-message-horario-dia' ).dialog( "close");
