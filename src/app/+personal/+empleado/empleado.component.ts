...
import {DocumentoEmpleadoDto} from "./documentoEmpleadoDto";
...
@Component({
  ...
  providers: [PaisService ,DatePipe]
})
export class EmpleadoComponent implements OnInit {
    ...
    constructor(private _service: NotificationsService, private empleadoService:EmpleadoService, private paisService:PaisService, private _router: Router) {
    ...
    cargarDocumentos(data:DocumentoEmpleado[]){
        ...
        for(var indice in this.view){
            if(this.view[indice].tipoDocumento == 'FO'){
                this.fotoEmpleado = new DocumentoEmpleado(this.view[indice].idDocumentoEmpleado,this.view[indice].nombre,this.view[indice].contenidoArchivo,this.view[indice].tipoArchivo,this.view[indice].nombreArchivo,'FO');
...
//empleado
    ...
    public entidadesFinancieras:TablaGeneralDto[];

    public afps:TablaGeneralDto[];

    public eps:TablaGeneralDto[];
    ...
    private getTiposDocumento() {
        this.empleadoService.completarComboBox('obtenerTipoDocumento').subscribe(
         tablaGeneralDto => this.cargarTipoDocumentoDefecto(tablaGeneralDto),
         error =>  this.errorMessage = <any>error);
    }

    private getEntidadFinanciera() {
        this.empleadoService.completarComboBox('obtenerEntidadFinanciera').subscribe(
            tablaGeneralDto => this.entidadesFinancieras = tablaGeneralDto,
            error =>  this.errorMessage = <any>error);
    }

    private getAFP() {
        this.empleadoService.completarComboBox('obtenerAFP').subscribe(
            tablaGeneralDto => this.afps = tablaGeneralDto,
            error =>  this.errorMessage = <any>error);
    }

    private getEPS() {
        this.empleadoService.completarComboBox('obtenerEPS').subscribe(
            tablaGeneralDto => this.eps = tablaGeneralDto,
            error =>  this.errorMessage = <any>error);
    }

    cargarTipoDocumentoDefecto(documentos:TablaGeneralDto[]){
    ...
    private getEstadosCivil() {
        this.empleadoService.completarComboBox('obtenerEstadoCivil').subscribe(
         tablaGeneralDto => this.estadosCivil = tablaGeneralDto,
         error =>  this.errorMessage = <any>error);
    }
    
    private getGruposSanguineo() {
        this.empleadoService.completarComboBox('obtenerGrupoSanguineo').subscribe(
         tablaGeneralDto => this.gruposSanguineo = tablaGeneralDto,
         error =>  this.errorMessage = <any>error);
    }
    
    private getGeneros() {
        this.empleadoService.completarComboBox('obtenerGenero').subscribe(
         tablaGeneralDto => this.generos = tablaGeneralDto,
         error =>  this.errorMessage = <any>error);
    }
    
    private getContratosTrabajo() {
        this.empleadoService.completarComboBox('obtenerContratoTrabajo').subscribe(
         tablaGeneralDto => this.contratosTrabajo = tablaGeneralDto,
         error =>  this.errorMessage = <any>error);
    }
    
    private getTiposTrabajo() {
        this.empleadoService.completarComboBox('obtenerTipoTrabajo').subscribe(
         tablaGeneralDto => this.tiposTrabajo = tablaGeneralDto,
         error =>  this.errorMessage = <any>error);
    }
    
    private getRegimenesHorario() {
        this.empleadoService.completarComboBox('obtenerRegimenHorario').subscribe(
         tablaGeneralDto => this.regimenesHorario = tablaGeneralDto,
         error =>  this.errorMessage = <any>error);
    }
    
    private getRegimenesLaboral() {
        this.empleadoService.completarComboBox('obtenerRegimenLaboral').subscribe(
         tablaGeneralDto => this.regimenesLaboral = tablaGeneralDto,
         error =>  this.errorMessage = <any>error);
    }
    ...
    navegarBusquedaEmpleado(data:Notificacion){
        if(data.codigo == 1){
