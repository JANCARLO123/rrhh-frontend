...
export class GridEditFormComponent {
    ...
    public uploadSaveUrl: string = 'http://'+this.localhost+':'+ this.port +'/empleado/importarArchivoEmpleados';
    public uploadRemoveUrl: string = 'http://'+this.localhost+':'+ this.port +'/empleado/eliminarArchivoEmpleados';

    public uploadValidation:FileValidation = {allowedExtensions:[".xls",".xlsx"]};
    ...
    public onSuccessUpload(event: SuccessEvent) {
        ...
        let url: string  = 'http://'+this.localhost+':'+ this.port +'/empleado/templateEmpleadosProcess';
    ...
    public descargarTemplateFormat() {
        let url:string = 'http://'+this.localhost+':'+ this.port +'/empleado/descargarTemplateEmpleados';
