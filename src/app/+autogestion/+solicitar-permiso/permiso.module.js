...
var permiso_component_1 = require("./permiso.component");
var smartadmin_validation_module_1 = require("../../shared/forms/validation/smartadmin-validation.module");
var PermisoModule = (function () {
    function PermisoModule() {
    }
    PermisoModule = __decorate([
        core_1.NgModule({
            imports: [
            ...
            declarations: [permiso_component_1.PermisoComponent],
            bootstrap: [permiso_component_1.PermisoComponent]
        }), 
        __metadata('design:paramtypes', [])
    ], PermisoModule);
    return PermisoModule;
}());
exports.PermisoModule = PermisoModule;
//# sourceMappingURL=permiso.module.js.map